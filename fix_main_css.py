...
:root {
  ...
  --color-accent-light: #FFD700 !important;
  --color-accent-dark: #D4AF37 !important;
  --color-accent-glow: rgba(255, 215, 0, 0.15) !important;
  --color-accent-gradient: linear-gradient(135deg, #FFD700, #F9D423) !important;
  --color-cta: #FFD700 !important;
  --color-cta-hover: #FFD700 !important;
  --color-cta-gradient: linear-gradient(135deg, #FFD700, #F9D423) !important;
  --color-star: #FFD700 !important;
  --primary-accent: #FFD700 !important;
  --premium-gradient: linear-gradient(135deg, #F9D423 0%, #FFD700 100%) !important;
